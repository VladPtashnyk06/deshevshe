                    ...
                    <div class="md:w-2/3">
                        <div>
                            <form action="" method="post">
                                ...
                                <div class="mb-4">
                                    <label for="user_name" class="block mb-2 font-bold">Ім'я користувача</label>
                                    <input type="text" name="user_name" id="user_name" class="w-full border rounded px-3 py-2" value="{{ $order->user_name }}">
                                </div>

                                <div class="mb-4">
                                    <label for="user_last_name" class="block mb-2 font-bold">Прізвище користувача</label>
                                    <input type="text" name="user_last_name" id="user_last_name" class="w-full border rounded px-3 py-2" value="{{ $order->user_last_name }}">
                                </div>

                                <div class="mb-4">
                                    <label for="user_phone" class="block mb-2 font-bold">Номер телефону користувача</label>
                                    <input type="text" name="user_phone" id="user_phone" class="w-full border rounded px-3 py-2" value="{{ $order->user_phone }}">
                                </div>

                                <div class="mb-4">
                                    <label for="user_email" class="block mb-2 font-bold">Електорна адреса користувача</label>
