                            ...
                            <tr class="text-center odd:bg-gray-200">
                                <td class="px-4 py-2 break-words max-w-xs text-xs">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <span>{{ $order->id }}</span>
                                        <a href="{{ route('operator.order.small-edit', $order->id) }}" onclick="return isOperator({{ $order->operator_id ?? null }})">
                                ...
                                <td class="break-words max-w-xs text-center">
                                    <a href="{{ route('operator.order.editFirst', $order->id) }}" class="p-2" onclick="return isOperator({{ $order->operator_id ?? null }})">
