                    ...
                    <table class="w-full mb-5">
                        ...
                        @foreach ($promotionalProducts as $product)
                            <tr class="text-center odd:bg-gray-200">
                                ...
                                <td class="px-6 py-4" style="word-wrap:break-word; max-width: 15rem; vertical-align: top;">{{ $product->price->retail }} UAH</td>
                                ...
                                <td class="px-6 py-4 text-right" style="vertical-align: middle; display: flex; gap: 10px;">
                                    <a href="{{ route('promotional.edit', $product->id) }}" title="Редагувати акційний товар">
                                    ...
                                    <form action="{{ route('promotional.delete' , $product->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" title="Видалити акційний товар">
