            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('size.update', $size->id) }}" method="post" class="max-w-4xl mx-auto" enctype="multipart/form-data">
                    ...
                    <div class="text-center mb-4">
                        <button type="submit" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded transition duration-300 ease-in-out w-full border">Оновити розмір</button>
                    </div>
                </form>
            </div>
        </div>
