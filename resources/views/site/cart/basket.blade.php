<x-site-layout>
    <main class="wrapper">
        ...
        <p class="page-look d-flex">
            ...
            <span>/</span>
            <span class="selected-page">кошик</span>
        </p>
        <div class="grid basket-grid">
            ...
            <div class="form-comment form-basket">
                <form action="#">
                    <p class="head-comment-form">ваше замовлення</p>
                    <div class="form-to-add_comment">
                        <div class="readmore basket-readmore">
                            <span>Промокод</span>
                        </div>
                        <p class="description-more basket-descr">
                            <input id="promo" name="promo" placeholder="Введіть промокод" type="text">
                        </p>
                        <div class="readmore basket-readmore">
                            <span>Застосувати сертифікат</span>
                        </div>
                        <p class="description-more basket-descr">
                            <input id="sertyficat" name="sertyficat" placeholder="Введіть сертифікат" type="text">
                        </p>
                    </div>
                    <div class="sum-basket flex-between item-center">
                        <p class="text-sum">Разом:</p>
                        <p class="sum">{{ number_format($cartItems->totalDiscountPrice, 2) }}₴</p>
                    </div>
                    <button class="btn-card yellow-cta basket-cta" type="submit">оформити замовлення</button>
                    <a class="transparent-cta basket-cta" href="#">назад у каталог</a>
                </form>
            </div>
        </div>
                        ...
                        <figcaption>
                            <div class="card-view-block item-center">
                                        ...
                                        <div class="haracteristic-block-card">
                                            <div class="hover-card">
                                                ...
                                                <div class="color d-flex item-center">
                                                    <label><input name="color" required="" type="radio" value="black"></label><label><input disabled name="color" required="" type="radio" value="red"></label><label><input name="color" required="" type="radio" value="blue"></label><label><input disabled name="color" required="" type="radio" value="gray"></label><label><input name="color" required="" type="radio" value="white"></label>
                                                </div>
                                ...
                                <div class="btn-view-block d-flex">
                                    <button class="blue-btn submit-btn orderCtaCard" type="submit">купити</button> <button class="oneClickBtn" title="Купити в 1 клік" type="submit"><svg style="enable-background:new 0 0 15 15;" version="1.1" viewbox="0 0 17 17" x="0px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" y="0px">
									<g>
                                        <g>
