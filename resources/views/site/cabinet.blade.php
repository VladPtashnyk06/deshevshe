                ...
                <div class="cabinet-cart basket-main cabinet-cart-product">
                    ...
                    <div class="bascket-card item-center">
                        ...
                        <div class="description-cart">
                            ...
                            <p class="text-cart d-flex item-center"><span>Колір:</span> <span class="color-cart"></span>
                            </p>
                        ...
                        <div class="count-cart">
                            <p class="d-flex text-cart item-center">
                                <span>Кількість:</span>
                                <a class="min" href="#">
                                    <svg fill="none" height="3" viewbox="0 0 8 3" width="8"
                                         xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a class="max" href="#">
                                    <svg fill="none" height="7" viewbox="0 0 8 7" width="8"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path d="M2.912 7.004V-0.0039978H4.256V7.004H2.912ZM0 4.14V2.876H7.168V4.14H0Z"
                                              fill="black"></path>
                                    </svg>
                                </a>
                            </p>
