<div id="footer">
    <hr class="footer-hr">
    <div class="footer gray-bgc">
        <div class="wrapper footer-grid">
            <div class="footer-nav">
                <nav>
                    <p class="footer-head">Інформація</p>
                    <ul>
                        <li>
                            <a href="{{ route('help', '#aboutUs') }}">Про нас</a>
                        </li>
                        <li>
                            <a href="{{ route('help', '#payDelivery') }}">Оплата та доставка</a>
                        </li>
                        <li>
                            <a href="{{ route('help', '#povernenia') }}">Повернення та обмін</a>
                        </li>
                        <li>
                            <a href="{{ route('help', '#question') }}">Питання та відповіді</a>
                        </li>
                    </ul>
                </nav>
                <nav>
...
<footer id="footer">
    ...
    <div class="mobile-fixed-footer grid">
        <a class="main-footer footer-fixed-icon" href="{{ route('site.index') }}">
            <svg fill="none" height="17" viewbox="0 0 17 17" width="17" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="tel-footer footer-fixed-icon" href="tel:+380681188181">
            <svg fill="none" height="17" viewbox="0 0 17 17" width="17" xmlns="http://www.w3.org/2000/svg">
